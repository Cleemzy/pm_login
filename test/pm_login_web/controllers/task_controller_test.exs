defmodule PmLoginWeb.TaskControllerTest do
  use PmLoginWeb.ConnCase

  alias PmLogin.Monitoring

  @create_attrs %{date_end: ~D[2010-04-17], date_start: ~D[2010-04-17], deadline: ~D[2010-04-17], estimated_duration: 42, performed_duration: 42, progression: 42, title: "some title"}
  ...
  def fixture(:task) do
    {:ok, task} = Monitoring.create_task(@create_attrs)
    task
  end
