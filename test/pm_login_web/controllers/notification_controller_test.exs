defmodule PmLoginWeb.NotificationControllerTest do
  use PmLoginWeb.ConnCase

  alias PmLogin.Services

  @create_attrs %{content: "some content", seen: true}
  @update_attrs %{content: "some updated content", seen: false}
  @invalid_attrs %{content: nil, seen: nil}

  def fixture(:notification) do
    {:ok, notification} = Services.create_notification(@create_attrs)
    notification
  end
