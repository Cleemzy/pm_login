defmodule PmLoginWeb.UserControllerTest do
  ...
  @create_attrs %{email: "some email", password: "some password", profile_picture: "some profile_picture", username: "some username"}
  ...
  def fixture(:user) do
    {:ok, user} = Login.create_user(@create_attrs)
    user
  end
